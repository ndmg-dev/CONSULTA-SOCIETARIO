...
export default function BatchSearchForm({ onStartBatch }) {
  ...
  const handleSubmit = (e) => {
    ...
    // Extrair possíveis CNPJs do texto (separados por quebra de linha, vírgula, etc)
  ...
  return (
    <form className="search-form" onSubmit={handleSubmit}>
      ...
      {error && (
        <p style={{ color: 'var(--color-error)', fontSize: 'var(--font-size-sm)', textAlign: 'left', marginTop: '0.5rem' }}>
          {error}
        </p>
      )}
