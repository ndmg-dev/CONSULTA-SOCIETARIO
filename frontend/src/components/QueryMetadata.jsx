...
export default function QueryMetadata({ metadata }) {
  ...
  return (
    <div className="query-metadata">
      ...
      <div className="query-metadata__item">
        ...
        {cached ? (
          <StatusBadge variant="info">Cache</StatusBadge>
        ) : (
          <StatusBadge variant="gold">Tempo real</StatusBadge>
        )}
      </div>
      ...
      {consulted_at && (
        <div className="query-metadata__item">
          ...
          <span className="query-metadata__value">
            {formatDateTime(consulted_at)}
          </span>
        </div>
      )}
