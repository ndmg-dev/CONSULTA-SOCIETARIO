...
function getSituacaoVariant(situacao) {
    ...
    <div className="company-summary">
      <div className="company-summary__header">
        <div className="company-summary__header-info">
          ...
          {nome_fantasia && (
            <span className="company-summary__fantasy">{nome_fantasia}</span>
          )}
          <span className="company-summary__cnpj">
            {cnpj ? formatCnpj(cnpj.toString().replace(/\D/g, '')) : '—'}
          </span>
        </div>
        <StatusBadge variant={getSituacaoVariant(situacao_cadastral)}>
      ...
      <div className="company-summary__field">
        ...
        <span className="company-summary__value">
          {formatDate(data_inicio_atividade)}
        </span>
      </div>
